    ...
    <section id="download" className="py-24 bg-gradient-to-br from-[#000428] via-[#004e92] to-[#001529] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
          <a
            href="#"
            className="group relative px-10 py-5 bg-white text-[#004e92] rounded-2xl font-bold text-xl shadow-2xl hover:shadow-[#FFD700]/50 transition-all duration-300 hover:scale-110 flex items-center gap-4 min-w-[280px] justify-center"
          >
          ...
          <a
            href="#"
            className="group relative px-10 py-5 bg-[#FFD700] text-[#000428] rounded-2xl font-bold text-xl shadow-2xl hover:shadow-white/50 transition-all duration-300 hover:scale-110 flex items-center gap-4 min-w-[280px] justify-center"
          >
            <Download className="w-7 h-7" />
            <div className="text-left">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <div className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
            <span className="text-white font-medium">📱 iOS 13.0以降対応</span>
          </div>
          <div className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
            <span className="text-white font-medium">🤖 Android 7.0以降対応</span>
          </div>
          <div className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
            <span className="text-white font-medium">📦 約50MB</span>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            ...
            <h3 className="text-xl font-bold text-white mb-2">本格的なゲーム体験</h3>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <div className="text-3xl mb-3">📚</div>
            <h3 className="text-xl font-bold text-white mb-2">88星座順次収録</h3>
            <p className="text-gray-300 text-sm">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <div className="text-3xl mb-3">💰</div>
            <h3 className="text-xl font-bold text-white mb-2">初級は完全無料</h3>
            <p className="text-gray-300 text-sm">
        ...
        <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
          ...
          <a
            ...
            className="inline-block px-6 py-3 bg-[#FFD700] text-[#000428] rounded-xl font-bold hover:bg-white transition-colors duration-300"
          >
        ...
        <div className="mt-8 text-center text-gray-400 text-sm">
          ...
          <p className="mt-2">© 2025 star⭐︎cone. All rights reserved.</p>
        </div>
      </div>
